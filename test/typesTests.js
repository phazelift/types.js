...
// copied from above and inverted result, to make a little haste..
  ...
  it("should return false for type Boolean arguments only", function(){
  ...
  it("should return false for type String arguments only", function(){
  ...
  it("should return false for type Number arguments only", function(){
  ...
  it("should return false for type String or Number arguments only", function(){
 ...
 it("should return false for type Array arguments only", function(){
 ...
 it("should return false for type Object arguments only", function(){
 ...
 it("should return false for type Function arguments only", function(){
 ...
 it("should return false for type RegExp arguments only", function(){
 ...
 it("should return false for type Date arguments only", function(){
 ...
 it("should return false for type NaN arguments only", function(){
 ...
 it("should return false for type null arguments only", function(){
 ...
 it("should return false for type undefined arguments only", function(){
...
it("should return true if all arguments are of type Boolean", function(){
 ...
 it("should return true if all arguments are of type Undefined", function(){
    ...
    result= Types.allUndefined( undefined, (function(){})(), undefined, console.log() );
    expect( result ).toBe( true );

    result= Types.allUndefined();
    expect( result ).toBe( true );

    result= Types.allUndefined( undefined, (function(){})(), null, undefined, console.log()  );
    expect( result ).toBe( false );
...
it("forceBoolean should return a Boolean when only one argument of any type is given", function(){
...
it("forceBoolean should return a Boolean when two or more non Boolean arguments are given", function(){
...
it("forceBoolean should return the value of the argument as a Boolean when it is a Boolean, or a Boolean false instead", function(){
...
it("forceBoolean should return the value of the second argument as a Boolean, or false, when the first argument is not a Boolean", function(){
...
it("forceString should return a String type value when only one(or no) argument of any type is given", function(){
...
it("forceString should return a String when two or more non String arguments are given", function(){
...
it("forceString should return the value of the only argument as a String when it is a String or Number, otherwise '' instead", function(){
...
it("forceString should return the value of the second argument as a String, or false, when the first argument is not a String", function(){
...
it("forceNumber should return a Number type value when only one(or no) argument of any type is given", function(){
...
it("forceNumber should return a Number type value when two or more non Number/(Number-String) arguments are given", function(){
...
it("forceNumber should return the value of the only argument as a Number, only when it is a Number/(Number-String), otherwise a Number 0 instead", function(){
...
it("forceNumber should return the value of the second argument as a Number, or false, when the first argument is not a Number", function(){
...
it("forceArray should return a Array type (according to types.js) value when only one(or no) argument of any type is given", function(){
...
it("forceArray should return a Array type value when two or more non Array arguments are given", function(){
...
it("forceArray should return the value of the only argument as an Array, only when it is an Array, otherwise an empty Array literal ([]) instead", function(){
...
it("forceArray should return the value of the second argument as an Array, or false, when the first argument is not a Array", function(){
...
it("forceObject should return a Object type (according to types.js) value when only one(or no) argument of any type is given", function(){
...
it("forceObject should return a Object type value when two or more non Object arguments are given", function(){
...
it("forceObject should return the value of the only argument as an Object, only when it is an Object, otherwise an empty Object literal {} instead", function(){
...
it("forceObject should return the value of the second argument as an Object or {}, when the first argument is not a Object", function(){
...
it("forceFunction should return a Function type (according to types.js) value when only one(or no) argument of any type is given", function(){
...
it("forceFunction should return a Function type value when two or more non Function arguments are given", function(){
...
it("forceFunction should return the value of the only argument as a Function, only when it is a Function, otherwise an empty function instead", function(){
...
it("forceFunction should return the second argument as a Function when the first argument is not of type Function", function(){
